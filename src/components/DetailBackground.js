  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      if(urlSearchParams.has("id")){
        ...
        let resp = await fetch(API_URI + "/api/v1/recruitment/detail?id=" + recruitmentID, {
          method: "GET",
          headers: {
  ...
  return (
    <div className={styles['detail-background']}>
      <div className={styles.box1}>
        ...
        {/*번호 매기기*/}
        <div className={styles.circle1}><span>1</span></div>
        <div className={styles.text1}>담당 업무</div>
        <p className={styles.p1}>{detailData ? detailData.jobCont : 'Loading...'}</p>
      </div>
      <div className={styles.box2}>
        ...
        <div className={styles["inner-box"]} />
        {/*번호 매기기*/}
        <div className={styles.circle2}><span>2</span></div>
      ...
      <div className={styles.box3}>
        ...
        <div className={styles["inner-box"]} />
        {/*번호 매기기*/}
        <div className={styles.circle3}><span>3</span></div>
